...
with col1:
    if st.button("Adicionar pedido extra e replanejar", key="btn_pedido_extra"):
        ...
        st.success("Pedido extra processado e rotas reotimizadas.")

        # Limpa campos
        st.session_state["cliente_extra"] = None
        for sku in CATALOG["sku"].unique():
            st.session_state[f"qtd_{sku}"] = 0

# Botão 2: Inserir novo pedido
with col2:
...
# Mapa D+1 condicionado à checkbox
...
# Mapa após pedido extra condicionado à checkbox
