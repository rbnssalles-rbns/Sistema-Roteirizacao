...
# ... (mantém as funções auxiliares: estimate_volume_weight, add_last_minute_order, try_append_to_existing_route, _map_center_from_orders, plot_routes_map)
...
# ✅ Exibe mapa após pedido extra se marcado
